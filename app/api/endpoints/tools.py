...
# Importar la instancia global del MCPClient y los modelos necesarios
...
# Ya no se necesita GenerateAndScheduleEmailRequest aquí, se movió a orchestration.py
...
# El endpoint de orquestación se ha movido a app/api/endpoints/orchestration.py
# y se incluye a través de app/api/routes.py
# Por lo tanto, el código duplicado del endpoint de orquestación que estaba aquí ha sido eliminado.
